...
(function() {
  ...
  function profileWithHistory(indexOrId) {
    ...
    const aiDay = (isActivelyPregnant && sow.insemination) ? Math.max(0, Math.round((new Date(new Date().toISOString().slice(0,10) + 'T00:00:00') - new Date(sow.insemination + 'T00:00:00')) / 864e5)) : null;
